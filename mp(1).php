...
$mess_priv->execute(array($_GET['id']));
    while ($donnees = $mess_priv->fetch())
    {
			...
			?>
				...
				if(htmlspecialchars($donnees['expediteur']=='Chef de guerre'))
				{
					?>
					<tr class="lu">
						<td class="no_msg_l"></td>
						<td class="no_msg"><a href="gestion_combat.php?id=<?php echo $test['id_player']; ?>"> <img src="images/icon/sword.png" class="img_att" alt="Sword"/>  Attaquer ce joueur</a></td>
						<td class="no_msg_r"></td>
					</tr>
					<?php 
				}
