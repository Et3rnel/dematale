...
{	
	...
	<div class="bandeau2">
		<a href="/Dematale/private.php"><?php if($membres['coupe']!=0){echo '<img src="images/coupes/'.$membres['coupe'].'.png" class="img_pts" alt="Coupe" height="20" width="20"/> ';} echo $_SESSION['pseudo']; ?> - <?php echo $membres['points']; ?> <img src="/Dematale/images/points.png" class="img_pts" align="bottom" alt="Points" title="Points" height="19"/></a>
	</div><br/>
		<img class="avat_menu" src="/Dematale/avatar/<?php echo $membres['avatar'];?>" alt="Votre avatar" height="100" width="100"/><br/><br/><br/>

	
	
	<div class="bandeau1">Développement</div>
	<table>
		<tr class="tr_ress"><td class="nbr_ress2"><a href="/Dematale/batiments.php">Bâtiments</a></td></tr>
		<tr class="tr_ress"><td class="nbr_ress2"><a href="/Dematale/technologies.php">Technologies</a></td></tr>
		<tr class="tr_ress-b"><td class="nbr_ress2"><a href="/Dematale/armee.php">Armée</a></td></tr>
	</table><br/>
	...
	<table>
		<tr class="tr_ress">
			<td class="icon_ress"><img src="/Dematale/images/fer_icon.png" title="Fer" alt="Icon du fer"/></td> 
			<td class="nbr_ress"><em id="fer"><?php echo number_format($ressources['fer'], 0, '.', ' '); ?></em></td>
		</tr>
		<tr class="tr_ress">		
			<td class="icon_ress"><img src="/Dematale/images/bois_icon.png" title="Bois" alt="Icon du bois"/></td> 
			<td class="nbr_ress"><em id="bois"><?php echo number_format($ressources['bois'], 0, '.', ' '); ?></em></td>
		</tr>
		<tr class="tr_ress">		
			<td class="icon_ress"><img src="/Dematale/images/roche_icon.png" title="Roche" alt="Icon de la roche"/></td> 
			<td class="nbr_ress"><em id="roche"><?php echo number_format($ressources['roche'], 0, '.', ' '); ?></em></td>
		</tr>
		<tr class="tr_ress-b">		
			<td class="icon_ress"><img src="/Dematale/images/gold_icon.png" title="Or" alt="Icon de l'or"/></td> 
		...
		<?php if($info['level'] >= 5)
		{
			?>
			<tr class="tr_ress-b">		
				<td class="icon_ress"><img src="/Dematale/images/titane_icon.png" title="Titan" alt="Icon du titan"/></td> 
				<td class="nbr_ress"><em id="titan"><?php echo number_format($ressources['titan'], 0, '.', ' '); ?></em></td>
			</tr>
			<?php
		} ?>
		<tr class="tr_ress-b">		
			<td class="icon_ress"><img src="/Dematale/images/paysan.png" title="Paysan" alt="Paysan(s)" height="25"/></td> 
	...
	<table>
		<tr class="tr_ress">
			<td class="icon_ress"><img src="/Dematale/images/arm_3.png" title="Recrue" alt="Recrue" height="25" width="25"/></td> 
			<td class="nbr_ress"><?php if($recrue['nombre']==0){echo 'Aucun';}else{echo number_format($recrue['nombre'], 0, '.', ' ');} ?></td>
		</tr>
		<tr class="tr_ress">		
			<td class="icon_ress"><img src="/Dematale/images/arm_2.png" title="Lieutenant" alt="Lieutenant" height="25" width="25"/></td> 
			<td class="nbr_ress"><?php if($lieutenant['nombre']==0){echo 'Aucun';}else{echo number_format($lieutenant['nombre'], 0, '.', ' ');} ?></td>
		</tr>
		<tr class="tr_ress">		
			<td class="icon_ress"><img src="/Dematale/images/arm_4.png" title="Capitaine" alt="Capitaine" height="25" width="25"/></td> 
		...
		<tr class="tr_ress_bold">		
			<td class="icon_ress"><img src="/Dematale/images/arm_1.png" title="Commandant" alt="Commandant" height="25" width="25"/></td> 
...
{ 
	...
	<p class="padd">Partez à la découverte de la phase terrestre !<br/><img src="/Dematale/images/terre.png" alt="Terre"/><br/>
	Puis de la phase spatiale !<br/><img src="/Dematale/images/galaxy.png" alt="Galaxie"/></p>
	<p class="padd">Inscrivez-vous !</p>
	<a href="/Dematale/register.php"><img src="/Dematale/images/inscription.png" alt="Inscription"/></a><br/><br/>
